  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text("Nova Instituição Parceira", 
              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildTextField("Ex: Instituto Mauá de Tecnologia", Icons.business),
                    ...
                    const Text("Coordenador Responsável", 
                      style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: Colors.black54)),
                    const SizedBox(height: 20),
                    
                    _buildFieldLabel("Nome Completo"),
                    _buildTextField("Ex: Prof. Dr. Carlos Mendes", Icons.person),
                    const SizedBox(height: 20),
                    
                    _buildFieldLabel("E-mail Acadêmico"),
                    _buildTextField("carlos.mendes@maua.br", Icons.email),
                    const SizedBox(height: 20),
                    ...
                    SizedBox(
                      ...
                      child: FilledButton(
                        onPressed: () {
                          if (_formKey.currentState!.validate()) {
                            ...
                            ScaffoldMessenger.of(context).showSnackBar(
                              SnackBar(
                                content: const Text("Universidade e Coordenador cadastrados!"),
                        ...
                        child: const Text("Salvar e Enviar Convite", 
                          ...
                          children: [
                            ...
                            OutlinedButton.icon(
                              onPressed: () {
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(builder: (context) => CoordinatorRegistrationPage()),
                                );
                              },
                              icon: const Icon(Icons.person_search, size: 20),
                              label: const Text("Ver tela que o Coordenador verá"),
