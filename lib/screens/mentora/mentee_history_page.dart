...
class _MenteeHistoryPageState extends State<MenteeHistoryPage> {
  ...
  Widget build(BuildContext context) {
    final filteredList = _allMentees.where((mentee) {
      final matchesFilter = _filter == "Todos" || mentee['status'] == _filter;
      final matchesSearch = mentee['name'].toString().toLowerCase().contains(_searchController.text.toLowerCase());
              ...
              child: Column(
                children: [
                      ...
                      GestureDetector(
                        ...
                        child: Row(
                          children: const [
                            ...
                            Text("Voltar", style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 16)),
                          ],
                        ),
                      ),
                      const Spacer(),
                      const Text("Histórico", style: TextStyle(color: Colors.white, fontSize: 20, fontWeight: FontWeight.bold)),
                      const Spacer(), 
                  ...
                  SingleChildScrollView(
                    ...
                    child: Row(
                      children: ["Todos", "Ativa", "Concluída", "Cancelada"].map((status) {
                        ...
                        return Padding(
                          ...
                          child: ChoiceChip(
                            ...
                            backgroundColor: brandColor.withOpacity(0.5), // Cor inativa (translucida)
            ...
            Expanded(
              child: Container(
                ...
                decoration: const BoxDecoration(
                  color: Color(0xFFF5F5F5), // Fundo levemente cinza para destacar os cards brancos
        ...
        children: [
            ...
            children: [
              CircleAvatar(
                ...
                child: Text(
                  ...
                  style: TextStyle(fontWeight: FontWeight.bold, color: brandColor, fontSize: 18),
                ),
              ),
              ...
              Expanded(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text(data['name'], style: const TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: Colors.black87)),
                    const SizedBox(height: 4),
                    Text(data['course'], style: TextStyle(fontSize: 13, color: Colors.grey[600])),
          ...
          Row(
            ...
            children: [
              ...
              _buildIconInfo(Icons.history_edu, "${data['meetings']} Encontros"),
            ],
          ),
        ],
      ),
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 15),
          Text("Nenhuma mentorada encontrada", style: TextStyle(color: Colors.grey[500], fontSize: 16)),
        ],
      ),
    );
  }
